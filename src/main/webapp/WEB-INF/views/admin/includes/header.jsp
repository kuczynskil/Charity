...
<aside id="left-panel" class="left-panel">
    <nav class="navbar navbar-expand-sm navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/admin/appusers"><img
            ...
            <ul class="nav navbar-nav">
                <li class="menu-item-has-children active dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="/admin/appusers">Users Table</a></li>
                        <li><i class="fa fa-table"></i><a href="/admin/admins">Admins Table</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-sign-in"></i><a href="/donate">App user panel</a></li>
                    </ul>
                </li>
            </ul>
        </div><!-- /.navbar-collapse -->
